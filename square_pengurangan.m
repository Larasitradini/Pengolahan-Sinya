...
grid on;
title('Sinyal Persegi 1 (f = 2 Hz) - Laras Itra Dini - 2411079005');
xlabel('Waktu (detik)');
ylabel('Amplitudo');
...
grid on;
title('Sinyal Persegi 2 (f = 4 Hz - Laras Itra Dini - 2411079005');
xlabel('Waktu (detik)');
ylabel('Amplitudo');
...
grid on;
title('Pengurangan Dua Sinyal Persegi - Laras Itra Dini - 2411079005');
xlabel('Waktu (detik)');
ylabel('Amplitudo');
